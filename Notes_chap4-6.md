...
![image-20221029202832580](https://cdn.jsdelivr.net/gh/Ga7777/Notes_NLPbook/imgs/202211021734773.png)

![image-20221029203004063](https://cdn.jsdelivr.net/gh/Ga7777/Notes_NLPbook/imgs/202211021734775.png)

- **词性标注**：x是单词序列，y是对应的词性序列。词性标注集有很多不同的，颗粒度也不同。

<!--注意：词性标注需要综合考虑前后单词与磁性才能决定当前单词的词性。需要使用概率模型去模拟。-->

![image-20221029203023327](https://cdn.jsdelivr.net/gh/Ga7777/Notes_NLPbook/imgs/202211021734777.png)

- **命名实体识别**：简短的人名和地名通过中文分词切分，然后通过词性标注确定所属列别。但有复合词时（丰度较小，导致分词器和词性标注器很难将其一步识别出来），需要在分词和词性标注的中间结果上进行召回。

<!--命名实体是OOV主要的组成部分-->

![image-20221029203139764](https://cdn.jsdelivr.net/gh/Ga7777/Notes_NLPbook/imgs/202211021734778.png)
...
![image-20221029204222836](https://cdn.jsdelivr.net/gh/Ga7777/Notes_NLPbook/imgs/202211021734779.png)

贝叶斯定理可以解释上图的箭头：

![image-20221029204336494](https://cdn.jsdelivr.net/gh/Ga7777/Notes_NLPbook/imgs/202211021734780.png)

### 4.2.2 模型三要素

1. 初始状态概率向量Π

![image-20221029204536063](https://cdn.jsdelivr.net/gh/Ga7777/Notes_NLPbook/imgs/202211021734781.png)

2. 状态转移概率矩阵A

![image-20221029204608869](https://cdn.jsdelivr.net/gh/Ga7777/Notes_NLPbook/imgs/202211021734782.png)

![image-20221029204654133](https://cdn.jsdelivr.net/gh/Ga7777/Notes_NLPbook/imgs/202211021734783.png)

3. 发射概率矩阵B

![image-20221029204714657](https://cdn.jsdelivr.net/gh/Ga7777/Notes_NLPbook/imgs/202211021734784.png)

![image-20221029204753008](https://cdn.jsdelivr.net/gh/Ga7777/Notes_NLPbook/imgs/202211021734785.png)

三要素作用示意图如下：

![image-20221029204829956](https://cdn.jsdelivr.net/gh/Ga7777/Notes_NLPbook/imgs/202211021734786.png)



***一个案例：医疗诊断***

![image-20221029205406976](https://cdn.jsdelivr.net/gh/Ga7777/Notes_NLPbook/imgs/202211021734787.png)

![image-20221029205447388](https://cdn.jsdelivr.net/gh/Ga7777/Notes_NLPbook/imgs/202211021734788.png)
...
![image-20221029205542724](https://cdn.jsdelivr.net/gh/Ga7777/Notes_NLPbook/imgs/202211021734789.png)
...
![image-20221029212513754](https://cdn.jsdelivr.net/gh/Ga7777/Notes_NLPbook/imgs/202211021734790.png)
...
![image-20221029212528822](https://cdn.jsdelivr.net/gh/Ga7777/Notes_NLPbook/imgs/202211021734791.png)
...
![image-20221029212538425](https://cdn.jsdelivr.net/gh/Ga7777/Notes_NLPbook/imgs/202211021734792.png)
...
![image-20221029213530051](https://cdn.jsdelivr.net/gh/Ga7777/Notes_NLPbook/imgs/202211021734793.png)

### 4.5.2 搜索状态序列的维特比算法

1. 问题定义：

![image-20221029213959016](https://cdn.jsdelivr.net/gh/Ga7777/Notes_NLPbook/imgs/202211021734794.png)
...
![image-20221029214323628](https://cdn.jsdelivr.net/gh/Ga7777/Notes_NLPbook/imgs/202211021734795.png)
...
![image-20221030154904934](https://cdn.jsdelivr.net/gh/Ga7777/Notes_NLPbook/imgs/202211021734796.png)
...
![image-20221030161211719](https://cdn.jsdelivr.net/gh/Ga7777/Notes_NLPbook/imgs/202211021734797.png)
...
![image-20221101155220680](https://cdn.jsdelivr.net/gh/Ga7777/Notes_NLPbook/imgs/202211021734798.png)
...
![image-20221101155507599](https://cdn.jsdelivr.net/gh/Ga7777/Notes_NLPbook/imgs/202211021734799.png)
...
![image-20221101155859479](https://cdn.jsdelivr.net/gh/Ga7777/Notes_NLPbook/imgs/202211021734800.png)

***从梯度下降理解参数更新方式：***

![image-20221101160248844](https://cdn.jsdelivr.net/gh/Ga7777/Notes_NLPbook/imgs/202211021734801.png)
...
![image-20221101161053828](https://cdn.jsdelivr.net/gh/Ga7777/Notes_NLPbook/imgs/202211021734802.png)

![image-20221101161159347](https://cdn.jsdelivr.net/gh/Ga7777/Notes_NLPbook/imgs/202211021734803.png)

![image-20221101161240119](https://cdn.jsdelivr.net/gh/Ga7777/Notes_NLPbook/imgs/202211021734804.png)
...
![image-20221101172550105](https://cdn.jsdelivr.net/gh/Ga7777/Notes_NLPbook/imgs/202211021734805.png)

（详见P174-178）

- 特征工程，可以将特征变得更复杂或者更简单，其对应的w参数也会变化。

![image-20221101172800394](https://cdn.jsdelivr.net/gh/Ga7777/Notes_NLPbook/imgs/202211021734806.png)
...
![image-20221101193131931](https://cdn.jsdelivr.net/gh/Ga7777/Notes_NLPbook/imgs/202211021734807.png)
...
![image-20221101194849196](https://cdn.jsdelivr.net/gh/Ga7777/Notes_NLPbook/imgs/202211021734808.png)

![image-20221101195015885](https://cdn.jsdelivr.net/gh/Ga7777/Notes_NLPbook/imgs/202211021734809.png)

![image-20221101195040620](https://cdn.jsdelivr.net/gh/Ga7777/Notes_NLPbook/imgs/202211021734810.png)
...
![image-20221101195448015](https://cdn.jsdelivr.net/gh/Ga7777/Notes_NLPbook/imgs/202211021734811.png)
...
![image-20221101200038706](https://cdn.jsdelivr.net/gh/Ga7777/Notes_NLPbook/imgs/202211021734812.png)
...
![image-20221101200350852](https://cdn.jsdelivr.net/gh/Ga7777/Notes_NLPbook/imgs/202211021734813.png)
...
![image-20221101201100316](https://cdn.jsdelivr.net/gh/Ga7777/Notes_NLPbook/imgs/202211021734814.png)
...
## 6.1 生成式与判别式模型![image-20221102161844602](https://cdn.jsdelivr.net/gh/Ga7777/Notes_NLPbook/imgs/202211021734815.png)

生成式模型和判别式模型详解：[机器学习中的判别式模型和生成式模型 - 知乎 (zhihu.com)](https://zhuanlan.zhihu.com/p/74586507)

我们之前学习的隐马尔可夫模型属于生成式模型。生成式模型有一个死穴：

![image-20221102162108142](https://cdn.jsdelivr.net/gh/Ga7777/Notes_NLPbook/imgs/202211021734816.png)
...
![image-20221102162816862](https://cdn.jsdelivr.net/gh/Ga7777/Notes_NLPbook/imgs/202211021734817.png)

![image-20221102170141060](https://cdn.jsdelivr.net/gh/Ga7777/Notes_NLPbook/imgs/202211021734818.png)

![image-20221102163113916](https://cdn.jsdelivr.net/gh/Ga7777/Notes_NLPbook/imgs/202211021734819.png)
...
![image-20221102163418033](https://cdn.jsdelivr.net/gh/Ga7777/Notes_NLPbook/imgs/202211021734820.png)

![image-20221102163459750](https://cdn.jsdelivr.net/gh/Ga7777/Notes_NLPbook/imgs/202211021734821.png)

**结构化感知机和条件随机场的联系：**

![image-20221102163532496](https://cdn.jsdelivr.net/gh/Ga7777/Notes_NLPbook/imgs/202211021734822.png)

即：预测算法也是维特比算法，只需要关注调剂随机场的训练算法。

### 6.3.2 CRF的训练

![image-20221102163811946](https://cdn.jsdelivr.net/gh/Ga7777/Notes_NLPbook/imgs/202211021734823.png)
...
![image-20221102164731559](https://cdn.jsdelivr.net/gh/Ga7777/Notes_NLPbook/imgs/202211021734824.png)

![image-20221102164909600](https://cdn.jsdelivr.net/gh/Ga7777/Notes_NLPbook/imgs/202211021734825.png)

### 6.3.4 CRF用于中文分词

![image-20221102170357878](https://cdn.jsdelivr.net/gh/Ga7777/Notes_NLPbook/imgs/202211021734826.png)

![image-20221102170428991](https://cdn.jsdelivr.net/gh/Ga7777/Notes_NLPbook/imgs/202211021734827.png)
...
![image-20221102173135645](https://cdn.jsdelivr.net/gh/Ga7777/Notes_NLPbook/imgs/202211021734829.png)